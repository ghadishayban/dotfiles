...
beautiful.init("/home/<your user path>/scripts/awesome/themes/default/theme.lua")
...
--myspacer = awful.widget.taglist(0)
--awful.widget.taglist(0, awful.widget.taglist.label.all, nil)
...
os.execute("redshift -l 32.762:-79.995 &")
os.execute("nm-applet &")
os.execute("gnome-settings-daemon &")
os.execute("synapse &")
os.execute("nautilus -n &")
